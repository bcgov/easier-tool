...
const officeOptions = [
  ...
  { value: '327 Surrey Guildford', label: '327 Surrey Guildford' },
  ...
  { value: '350 Lower Mainland Contact Centre (LMCC)', label: '350 Lower Mainland Contact Centre (LMCC)' },
  { value: '400 Kamloops Regional', label: '400 Kamloops Regional' },
  { value: '403 Kelowna Landmark', label: '403 Kelowna Landmark' },
  { value: '407 Creston (SBC)', label: '407 Creston (SBC)' },
  { value: '408 Revelstoke (SBC)', label: '408 Revelstoke (SBC)' },
  { value: '409 Bella Coola (SBC)', label: '409 Bella Coola (SBC)' },
  { value: '411 Cranbrook (SBC)', label: '411 Cranbrook (SBC)' },
  { value: '413 Golden (SBC)', label: '413 Golden (SBC)' },
  { value: '415 Fernie (SBC)', label: '415 Fernie (SBC)' },
  { value: '420 Grand Forks (SBC)', label: '420 Grand Forks (SBC)' },
  { value: '421 Trail', label: '421 Trail' },
  { value: '422 Nelson', label: '422 Nelson' },
  { value: '423 Nakusp (SBC)', label: '423 Nakusp (SBC)' },
